...
> **3. John Doe** — SVP, Senior Tech Manager – Application Development (California, United States)
> [linkedin.com/in/johndoe](https://linkedin.com/in/johndoe) · warm intro via Jane Roe (Continental Bank)
>
...
> Past employers with relevant tech: acme financial | globex bank | initech.
>
...
> - **[buyer]** He has proven oversight of major legacy-to-vendor migrations valued at hundreds of millions of dollars and designed custom integration services — "Successfully oversaw the migration of a large in-house legacy servicing platform worth $250 million to a vendor solution" — "Designed and patented a custom data-integration service on an internal platform." Demonstrating his capacity to manage high-stakes budgets and lead complex architectural integrations.
> - **[technical]** His technical background spans the modernization of core applications using OpenShift and Kafka while integrating disparate systems via an internal platform — "Leading cloud migration of internal applications to RHEL, OpenShift Container Platform" — "Building a new integration platform leveraging Kafka and a modern event-driven stack." Highlighting his deep hands-on expertise.
> - **[warm]** He maintains a professional connection to Artifex through Jane Roe, with whom he overlapped for 45 months as a senior leader at Continental Bank.
>
